...
class LQGT_dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.opt['phase'] == 'train':
            ...
            scene = os.path.basename(gt_subfolder)[:-4]
        else:
            ...
            scene = os.path.basename(gt_subfolder)

        return {'LQ': img_lqs, 'GT': img_gts, 'LQ_path': lq_subfolder, 'GT_path': gt_subfolder, 'scene': scene}
